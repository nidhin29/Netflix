...
/// @nodoc
mixin _$SearchState {
  List<D> get d => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<D> d, List<Downloads> idlelist, bool isLoading, bool isError});
}
...
class _$_SearchState implements _SearchState {
  ...
  @override
  String toString() {
    return 'SearchState(d: $d, idlelist: $idlelist, isLoading: $isLoading, isError: $isError)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_d),
